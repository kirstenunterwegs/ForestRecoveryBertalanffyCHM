...
try({
fit_fe_sub250_cmdLOG_asymlap27 = brm(  
  bf(
  ...
  prior = c(
    ...
    ,prior(normal(0, 0.5), lb = 0, nlpar = hmaxstarLOG, class = "sd")  # --- hmaxstar
...
# save model
save(fit_fe_sub250_cmdLOG_asymlap27, file = "03_work/models/model_fits/fit_fe_sub250_cmdLOG_asymlap27.RData")
